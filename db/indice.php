    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <img class="d-block w-100" src="<?php echo base_url().'/assets/img/slide/0.png';?>" alt="Ir al Memoria del Mundo">
                </a>
            </div>
            <div class="carousel-item">
                <a href="<?php echo base_url().'educainnova';?>">
                <img class="d-block w-100" src="<?php echo base_url().'/assets/img/slide/1.png';?>" alt="Ir a Educa Innova">
                </a>
            </div>
            <div class="carousel-item">

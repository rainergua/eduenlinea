...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-04-2021 a las 04:55:54
...
(0, 'DOSIFICACION DE CONTENIDOS', '*.pdf, *.doc'),
...
(16, 'TUTORIAS', '*.pdf, *.doc'),
(17, 'APRENDIZAJES APLICADOS', '*.pdf, *.doc'),
(18, 'APRENDIZAJES COMPLEMENTARIOS', '*.pdf, *.doc'),
(19, 'APRENDIZAJES ESPECIALIZADOS', '*.pdf, *.doc'),
(20, 'DOSIFICACION DE CONTENIDOS', '*.pdf, *.doc'),
(21, 'Tutoriales', '*.mp4'),
(22, 'Videos de nivel inicial', '*.mp4'),
(23, 'Radio Clases', '*.mp3');

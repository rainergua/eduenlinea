...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-ld-6">
            <div class="card">
                <h5 class="card-header">Cuento del Coronavirus</h5>
                <div class="card-body">
        ...
        <div class="col-sm-12 col-md-6 col-ld-6">
            <div class="card">
                <h5 class="card-header">Jugamos a escuchar</h5>
                <div class="card-body">
                    <div class="embed-responsive embed-responsive-16by9">
                        <video src="<?php echo base_url().'/assets/img/video/ini2.mp4';?>" controls></video>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-ld-6">
            <div class="card">
                <h5 class="card-header">La silla en su lugar</h5>
                <div class="card-body">
                    <div class="embed-responsive embed-responsive-16by9">
                        <video src="<?php echo base_url().'/assets/img/video/ini3.mp4';?>" controls></video>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-6 col-ld-6">
            <div class="card">
                <h5 class="card-header">Lavado de manos</h5>
                <div class="card-body">
                    <div class="embed-responsive embed-responsive-16by9">
                        <video src="<?php echo base_url().'/assets/img/video/ini4.mp4';?>" controls></video>
                    </div>
                </div>
            </div>
        </div>

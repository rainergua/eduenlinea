        ...
        <div class="row my-4 py-4">
                ...
                <div class="row my-1 py-1">
                    ...
                    <div class="col-sm-12 col-md-8 col-ld-8 text-center">
                        <div class="card-block">
                            <h5 class="card-title">Resolución Ministerial 001/2021 - Educación Regular</h5>
            ...
            <div class="col-sm-12 col-md-4 col-ld-4 text-center">
                <div class="row my-1 py-1">
                    ...
                    <div class="col-sm-12 col-md-8 col-ld-8 text-center">
                        <div class="card-block">
                            <h5 class="card-title">Resolución Ministerial 001/2021 - Educación Alterativa y Especial</h5>
            ...
            <div class="col-sm-12 col-md-4 col-ld-4 text-center">
                <div class="row my-1 py-1">
                    ...
                    <div class="col-sm-12 col-md-8 col-ld-8 text-center">
                        <div class="card-block">
                            <h5 class="card-title">Resolución Ministerial 001/2021 - Educación Superior y formación Profesional</h5>

...
<nav class="my-1 py-1">
    <ul>
		...
		<li><a id='pdf' href="<?php echo base_url().'assets/files/mineria.pdf'?>" title='Descarga PDF' target="_blank">PDF File</a></li>
    </ul>
</nav>
	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-ld-12 text-center">
			<div id="mybook">
                ...
                <?php
                for($i=1; $i<=13;$i++){?>
                    <div> <img src="<?php echo base_url().'assets/libros/mineria/pag'.$i.'.png'?>" class="img-fluid">  </div>
                <?php
                }?>

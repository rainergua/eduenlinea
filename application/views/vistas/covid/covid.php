<div class="container-fluid trans">
    <div class="container">
        ...
        <div class="row py-2 my-2">
            <div class="col-sm-12 col-md-4 col-ld-4 py-2 my-2">
                <img src="<?php echo base_url().'assets/img/eblogo.png';?>" class="img-fluid" alt="Concurso de conmemoración al día del mar">
                </a>
            </div>
            
            <div class="col-sm-12 col-md-8 col-ld-8 form-group">
                <?php

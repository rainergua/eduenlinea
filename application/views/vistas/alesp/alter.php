    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3 col-ld-3 mt-4 pt-4 text-center">
                <a href="<?php echo base_url().'conales/alteruno/9';?>">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3 col-ld-3 mt-4 pt-4 text-center">
                <a href="http://spcc.minedu.gob.bo/" target="_blank">
                    <img src="<?php echo base_url().'/assets/img/alesp/spcc.png';?>" class="boton-sec img-fluid">
                </a>
            </div>
            <div class="col-sm-12 col-md-3 col-ld-3 mt-4 pt-4 text-center">
                <a href="http://cepead.minedu.gob.bo/" target="_blank">

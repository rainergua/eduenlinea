<div class="container-fluid contenido">
    <div class=" container d-flex justify-content-center py-2 my-2">
        <ul class="pagination shadow-lg">
            ...
            <li class="page-item"><a class="page-link " href="<?php echo base_url().'conales/nivel/10'?>">Educación Especial</a></li>
            <li class="page-item active"><a class="page-link " href="<?php echo base_url().'conales/discapacidad'?>">Discapacidad</a></li>
        </ul>
    </div>
    <div class="container">
        <div class="row pb-2">

...
<div class="container contenido">
    <div class="row pt-4">
        <div class="col-12 col-sm-12 col-md-12 col-ld-12 text-center">
            ...
            <h5 class="font-italic">Libros de texto</h5>
        </div>
    </div>
    <div id="accordion">
    <div class="row pb-4 mt-4 mb-4" id="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                ...
                <div class="ih-item square colored effect13 left_to_right">
                    ...
                    if(!$arch->lnk_mat){
                    ?>
                    <a href="" data-toggle="modal" data-target="#exampleModalCenter" id="<?=$arch->arch_mat?>" class="nano">
                    <?php
                    }else{
                    ?>
                    <a href="<?php echo $arch->lnk_mat?>" target="_blank">
                    <?php
                    }
                    ?>

<div class="container-fluid contenido">
    ...
    <div id="carouselExampleIndicators" class="carousel slide pt-4 mt-4" data-ride="carousel">
        ...
        <div class="row mt-4 pt-4">
            <div class="col-sm-12 col-md-3 col-ld-3 text-center">
                <a href="<?php echo base_url().'contenido/nivel/4';?>">
                <img src="<?php echo base_url().'/assets/img/rini.png';?>" class="img-fluid boton-sec mt-1 pt-1">
                </a>
            </div>
            <div class="col-sm-12 col-md-9 col-ld-9 text-center">
                <div class="card-block">
                    <h5 class="card-title">Educación Inicial en Familia Comunitaria</h5>
                    <p class="card-text text-justify">La Educación Inicial en Familia Comunitaria, brinda una educación integral, 
                    inclusiva y pertinente a niñas y niños de 0 a 5 años vinculando las actividades de la vida familiar y comunitaria 
                    con las actividades de la escuela, que permita desarrollar capacidades, potencialidades y habilidades cognitivas, 
                    lingüísticas, psicomotrices, socio-afectivas, espirituales y artísticas que favorezcan a las actitudes de autonomía, 
                    cooperación y toma de decisiones en el proceso de construcción de su pensamiento, para iniciar procesos de aprendizaje 
                    sistemáticos en el siguiente año de escolaridad. </p>
                </div>
            </div>
        </div>
        <div class="row mt-2 pt-2"> 
            ...
            <div class="col-sm-12 col-md-9 col-ld-9 text-center">
                <div class="card-block">
                    <h5 class="card-title">Educación Primaria Comunitaria Vocacional</h5>
                    <p class="card-text text-justify">Educación Primaria Comunitaria Vocacional, comprende la formación básica, 
                    cimiento de todo el proceso de formación posterior y tiene carácter intracultural, intercultural y plurilingüe. 
                    Su objetivo es desarrollar en los estudiantes todas sus capacidades, potencialidades, conocimientos, saberes, 
                    capacidades comunicativas, ético-morales, espirituales, afectivas, razonamientos lógicos, científicos, técnicos, 
                    tecnológicos y productivos, educación física, deportiva y artística. Los conocimientos y la formación cualitativa 
                    de las y los estudiantes, en relación y afinidad con los saberes, las ciencias, las culturas, la naturaleza y 
                    el trabajo creador, están destinados a orientar su vocación.</p>
                </div>
            </div>
        ...
        <div class="row mt-2 pt-2">
            <div class="col-sm-12 col-md-3 col-ld-3 text-center">
                <a href="<?php echo base_url().'contenido/nivel/6';?>">
                <img src="<?php echo base_url().'/assets/img/rsec.png';?>" class="img-fluid boton-sec mt-1 pt-1">
                </a>
            </div>
            <div class="col-sm-12 col-md-9 col-ld-9 text-center">
                <div class="card-block">
                    ...
                    de nuestros pueblos y sus culturas en diálogos con el conocimiento universal, incorporando la formación histórica, 
                    cívica y comunitaria.</p>
                </div>
            </div>
        </div>
    </div>
